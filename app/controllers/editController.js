...
function($http, $scope, $timeout, $location, $routeParams) {			
	...
	function addInternacion(internacion){
		let params = {};
		params.url = '/api/index.php/internaciones_relacionadas_con_enfermedad_de_base';
		params.method = 'POST';
		params.data = { data :
			{
	...
	vm.saveEditInternacion = function(){
		let params = {};
		params.url = '/api/index.php/internaciones_relacionadas_con_enfermedad_de_base/'+vm.form_edit.id;
		params.method = 'POST';
		params.data = { data :
			{
	...
	vm.deleteInternacion = function() {
		let params = {};
		params.url = '/api/index.php/internaciones_relacionadas_con_enfermedad_de_base/delete';
		params.method = 'POST';
		params.data = { data : 
			{
				id : vm.id_delete,
